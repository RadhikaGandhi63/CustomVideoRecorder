...
public class DetailedImageVideo extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // audio_path="android.resource://com.aryan.dhankar.customcamera/raw/gullyme";
      //  Log.e("check",audio_path);
        setUI();
     //   startaudio();
    ...
    public void startaudio(){
        ...
        int resID=getResources().getIdentifier("gullyme", "raw", getPackageName());

        MediaPlayer mediaPlayer=MediaPlayer.create(this,resID);
        mediaPlayer.start();

     /*   MediaPlayer mp = new MediaPlayer();
        String audio_path="android.resource://com.aryan.dhankar.customcamera/raw/";
        try {
            mp.setDataSource(audio_path + File.separator + "gullyme");
            mp.prepare();
            mp.start();
        } catch (Exception e) {
            e.printStackTrace();
